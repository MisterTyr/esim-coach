...
## Email 1 — Welcome + the one-minute rule (Day 0)

**Subject:** Your eSIM shortcut (read this before your next trip)
**Preview:** The one-minute check that saves you from roaming bills.
...
## Email 2 — How to install one (Day 3)

**Subject:** Install your eSIM in 5 minutes (iPhone + Android)
**Preview:** Do it over Wi-Fi before you fly.

Hi {{first_name}},

Installing an eSIM is easier than people expect. Do it at home over Wi-Fi, then switch it on when you land.
...
## Email 3 — The savings playbook (Day 7)

**Subject:** Three ways travellers overpay for data
**Preview:** And the cheaper move each time.

Hi {{first_name}},

Three common ways to overpay abroad — and what to do instead:

1. **Carrier roaming.** Convenient, usually the priciest. A prepaid travel eSIM is often a fraction of the cost.
2. **Buying too much data.** Maps and messaging sip data. For most trips a mid-size plan is plenty; top up if you run low.
...
## Email 4 — Stay in the loop (Day 14)

**Subject:** Where's your next trip?
**Preview:** We refresh the rankings daily.
...
## Notes
- Keep it evergreen: no dates, no "this week's deal." These should read fine a year from now.
- Compliance: every email needs a physical address and an unsubscribe link (your email tool adds these).
- If you automate copy generation later, use the prompt in `prompts/06-email-and-social.md`.
