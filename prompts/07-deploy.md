...
4. Deploy. Add your domain (esim.coach) under the Pages project's Custom Domains.
...
3. The `CNAME` file already points at esim.coach — set that domain in Pages settings
