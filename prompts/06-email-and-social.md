# Prompt 06 — Email and social copy

**When:** ongoing. **Edits:** none in the repo — paste output into your email/social tools.

The 4-email welcome sequence already exists in `automation/email-sequence.md`.
Use these prompts for ongoing content. Bulk social captions are ideal for a
cheap model — don't spend frontier tokens on tweets.
...
## Repurpose an article into a thread

PASTE THIS:

```
Turn this article into a 5-post thread for social. Each post under 240 chars,
plain language, last post links to the full guide at [URL]. Return posts
numbered 1-5, nothing else.
